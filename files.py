...
'''
#The Second variant Read with self-closing
...
#The Second variant Write with self-closing
with open ("C:\\Distrib\\Python\\files\\logStatic.txt", "w") as a:
    a.write('Gona!\n')
    a.write(str(99995) + '\n')
    a.write('Self control!')    
